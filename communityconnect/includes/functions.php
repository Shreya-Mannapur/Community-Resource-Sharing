...
function drawHeader($s=0 ,$crousel=true){
    ...
    <div class='container '>
		<a class='navbar-brand' href='index.php'><h><span><b><font color='#06A353' size='6px'>Community</b></font> <span><b>connect</h></a>";
		if(isLogged() == 1){
			logout();
			myaccount();
			if($crousel){
						...
						<div class="row">
							<div class="col-md-9">
								<div class="slider-content">
									<h1 data-animation="animated lightSpeedIn">Welcome to</h1>
									<h2 data-animation="animated lightSpeedIn">Community Resource Sharing</h2>
									<p data-animation="animated lightSpeedIn">Sell or buy used or new products in minutes only on Community connect.</p>
									<div class="ad-btn">
									<a class="btn btn-lg btn-success text-white addads"href="createads.php">Add product</a>
									</div>
								</div>
							</div>
						</div><!-- row -->
						...
						<div class="row">
							<div class="col-md-9">
								<div class="slider-content">
									...
									<p data-animation="animated lightSpeedIn">Sell or buy used or new products in minutes only on Community connect.</p>
									<div class="ad-btn">
									<a   class="btn btn-lg btn-success text-white addads" href="" data-toggle="modal data-target="#myModal">Add product</a>
									</div>
								</div>
							</div>
						</div><!-- row -->
